...
We present a HTTP-based protocol called SASHA; a hybrid approach to home automation, with a focus on privacy and security. Communication in general is done peer-to-peer, while configuration and management is done in a client/server manner. The system is extensible, and in addition it automatically and gracefully handles failures in units and network.
